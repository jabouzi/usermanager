		...
		<form action="/<?php echo get_site_lang(); ?>/login/process" method="post">
			<fieldset name="connexion">
				<table align="center" border="0" cellpadding="5" cellspacing="0" class="form-table w100">
					<tr>
						<th nowrap="nowrap" width="50%"><label for="email"><?php echo lang('form.username'); ?> / <?php echo lang('form.email'); ?>:</label></th>
					...
					<tr>
						...
						<td nowrap="nowrap"><input id="password" class="w100" name="password" tabindex="2" type="password" value="<?php echo $password; ?>" /></td>
					</tr>
					<tr>
						<td colspan="2"><hr /></td>
					</tr>
					...
					<tr>
						<td align="center" colspan="2"><a href="/<?php echo get_site_lang(); ?>/login/password"><?php echo lang('title.password'); ?></a></td>
					</tr>
				</table>
			</fieldset>
		</form>
