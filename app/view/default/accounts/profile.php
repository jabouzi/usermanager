	<div id="right-container">
		<div id="content-page">
			<?php display_message(); ?>
<form action="/<?php echo get_site_lang(); ?>/application/processprofile" method="post" id="editform">
<fieldset>
    ...
    <tr>
		...
		<td><input type="text" name="username" id="username" value="<?php echo print_post_text('username', $user->get_username()); ?>" readonly /></td>
	</tr>
    <tr>
